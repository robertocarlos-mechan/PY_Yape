...
public class IngresoPinActual implements Task {
    ...
    public <T extends Actor> void performAs(T actor){
        actor.attemptsTo(
                WaitUntil.the(TransferenciaYapePage.TXT_PIN_ACTUAL, isEnabled()).forNoMoreThan(5).seconds(),
                Click.on(TransferenciaYapePage.TXT_PIN_ACTUAL),
                Enter.theValue(pin_actual).into(TransferenciaYapePage.TXT_PIN_ACTUAL),
