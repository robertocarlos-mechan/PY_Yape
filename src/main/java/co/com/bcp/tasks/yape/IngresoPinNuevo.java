...
public class IngresoPinNuevo implements Task {
    ...
    public <T extends Actor> void performAs(T actor){
        actor.attemptsTo(
                WaitUntil.the(TransferenciaYapePage.TXT_NUEVO_PIN, isEnabled()).forNoMoreThan(5).seconds(),
                Click.on(TransferenciaYapePage.TXT_NUEVO_PIN),
                Enter.theValue(pin_new).into(TransferenciaYapePage.TXT_NUEVO_PIN),
