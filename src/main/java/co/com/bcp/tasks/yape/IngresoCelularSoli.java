...
public class IngresoCelularSoli implements Task {
    ...
    public <T extends Actor> void performAs(T actor){
        actor.attemptsTo(
                WaitUntil.the(TransferenciaYapePage.TXT_CELULAR_SOLI, isEnabled()).forNoMoreThan(5).seconds(),
                Click.on(TransferenciaYapePage.TXT_CELULAR_SOLI),
                Enter.theValue(celular_soli).into(TransferenciaYapePage.TXT_CELULAR_SOLI));
    }
}
